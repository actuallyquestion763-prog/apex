  ...
  return (
    <div>
      ...
      <div
        ...
        className={`flex min-h-[140px] cursor-pointer flex-col items-center justify-center gap-2 rounded-xl border-2 border-dashed px-4 py-6 text-center transition ${dragOver ? 'border-ocean-400 bg-ocean-500/5' : 'border-ink-600 bg-ink-900 hover:border-ink-500'}`}
      >
        {file ? (
          <>
          ...
          <>
            ...
            <p className="text-xs text-slate-400">Click or drag an image here</p>
            <p className="text-[11px] text-slate-600">JPG, PNG, WebP · up to 5MB</p>
          </>
        )}
      </div>
      <input
